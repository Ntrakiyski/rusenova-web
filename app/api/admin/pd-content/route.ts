...
export async function GET() {
  try {
    // Return the current PD projects data
    return NextResponse.json({
      success: true,
      data: productDesignProjects
    });
  } catch (error) {
    console.error('Error reading PD content:', error);
    return NextResponse.json(
      { 
        success: false,
        error: 'Failed to read PD content',
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate the entire array of projects
    ...
    // Write to file - update the productDesignProjects.ts file
...
`;
    ...
    return NextResponse.json({
      success: true,
      message: 'PD projects saved successfully',
      data: updatedProjects
    });
  } catch (error) {
    console.error('Error saving PD content:', error);
    return NextResponse.json(
      { 
        success: false,
        error: 'Failed to save PD content',
        details: error instanceof Error ? error.message : 'Unknown error'
      },
      { status: 500 }
    );
...
`;
    ...
    console.error('Error updating PD content:', error);
    return NextResponse.json(
      { 
        success: false,
        error: 'Failed to update PD content',
        details: error instanceof Error ? error.message : 'Unknown error'
      },
      { status: 500 }
    );
...
`;
    ...
    console.error('Error deleting PD content:', error);
    return NextResponse.json(
      { 
        success: false,
        error: 'Failed to delete PD content',
        details: error instanceof Error ? error.message : 'Unknown error'
      },
      { status: 500 }
    );
